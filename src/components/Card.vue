<template>
    <div class="max-w-sm rounded bg-gray-800">
        ...
        <div class="px-6 py-4">
            <div class="font-bold text-xl text-white tracking-wide">Card title</div>
            <div class="text-gray-200 text-sm mb-3">Secondary text</div>
